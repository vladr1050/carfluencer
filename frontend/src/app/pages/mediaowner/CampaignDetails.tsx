...
export function MediaOwnerCampaignDetails() {
  ...
  if (error || !c) {
    return (
      <div className="p-8">
        <Link to="/media-owner/campaigns" className="text-sm text-muted-foreground mb-4 inline-block">
          ← Back
        </Link>
  ...
  return (
    <div className="p-8 max-w-5xl">
      <Link to="/media-owner/campaigns" className="inline-flex items-center gap-2 text-sm text-muted-foreground mb-6 hover:text-foreground">
