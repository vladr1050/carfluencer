...
export function ContentBlockBody({ body }: { body: string }): JSX.Element {
  ...
  return (
    <div
      className="space-y-2 text-sm leading-relaxed text-muted-foreground [&_a]:font-medium [&_a]:text-accent [&_a]:underline [&_h2]:text-base [&_h3]:text-sm [&_ul]:list-disc [&_ul]:pl-5"
