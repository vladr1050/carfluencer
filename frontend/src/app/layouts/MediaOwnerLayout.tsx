...
export function MediaOwnerLayout() {
  ...
  const menuItems = [
    { path: '/media-owner', label: 'Dashboard', icon: LayoutDashboard },
    { path: '/media-owner/vehicles', label: 'Vehicles', icon: Car },
    { path: '/media-owner/campaigns', label: 'Campaigns', icon: Briefcase },
    { path: '/media-owner/earnings', label: 'Earnings', icon: DollarSign },
  ];
