...
export default function AdvRegisterPage(): JSX.Element {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted p-6">
      <div className="w-full max-w-lg rounded-2xl border border-border bg-card p-8 shadow-sm">
        <h1 className="mb-2 text-xl font-bold text-foreground">Advertiser registration</h1>
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          <Link className="font-medium text-brand-magenta hover:underline" to="/advertiser/login">
